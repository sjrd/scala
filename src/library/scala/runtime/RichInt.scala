...
final class RichInt(private val self: Int) extends AnyVal {
  ...
  /** Returns `true` iff this is within the range of [[scala.Byte]] MinValue
    * and MaxValue; otherwise returns `false`.
    */
  def isValidByte: Boolean = self.toByte.toInt == self

  /** Returns `true` iff this is within the range of [[scala.Short]] MinValue
    * and MaxValue; otherwise returns `false`.
    */
  ...
  /** Returns `true` iff this is within the range of [[scala.Char]] MinValue
    * and MaxValue; otherwise returns `false`.
    */
  @deprecated("statically known to be true", "2.14.0")
